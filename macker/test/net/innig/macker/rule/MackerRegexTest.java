...
public final class MackerRegexTest
    extends TestCase
    {
    ...
    private void testMatches(MackerRegex re, String[] positive, String[] negative)
        throws Exception
        {
        for(int n = 0; n < positive.length; n++)
            assertTrue(
                "\"" + re + "\" should match \"" + positive[n] + "\"",
                re.matches(context, positive[n]));
        
        for(int n = 0; n < negative.length; n++)
            assertTrue(
                "\"" + re + "\" shouldn't match \"" + negative[n] + "\"",
                !re.matches(context, negative[n]));
        }
    ...
    public void test_basic()
        ...
        testMatches(
            new MackerRegex("String"),
            new String[] { "String" },
            new String[] { "java.lang.String" });

        testMatches(
            new MackerRegex("java.lang.String"),
            new String[] { "java.lang.String" },
            new String[] { "String" });
    ...
    public void test_variable()
        ...
        testMatches(
            new MackerRegex("*${rav}*"),
            new String[] { "Apple" },
            new String[] { "granny.smith.Apple", "Apple.computer" });
        }
