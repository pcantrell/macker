...
public class RuleSetBuilder {
	...
	private Collection<RuleSet> build(SweetToXmlConverter converter) throws RulesException {
		try {
			return build(saxBuilder.build(converter.getResultReader()));
		} catch (JDOMException jdome) {
			throw new RulesDocumentException(jdome);
		} catch (IOException ioe) {
			throw new RulesDocumentException(ioe);
	...
	public Pattern buildPattern(Element patternElem, RuleSet ruleSet, boolean isTopElem, Pattern nextPat)
		...
		if (filterName != null) {
			...
			head = filter.createPattern(ruleSet, (head == null) ? new ArrayList<Pattern>() : Collections
